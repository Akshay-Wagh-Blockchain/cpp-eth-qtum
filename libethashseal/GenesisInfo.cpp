...
#include "genesis/glitchMainNetwork.cpp"
...
#include "genesis/test/glitchTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
    ...
    {
    //Client genesis
    case Network::glitchMainNetwork: return c_genesisInfoGlitchMainNetwork;
    case Network::MainNetwork: return c_genesisInfoMainNetwork;
    case Network::Ropsten: return c_genesisInfoRopsten;

    //Test genesis
    case Network::glitchTestNetwork: return c_genesisInfoGlitchTestNetwork;
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
    switch (_n)
    {
    case Network::glitchMainNetwork: return c_genesisStateRootGlitchMainNetwork;
    case Network::glitchTestNetwork: return c_genesisStateRootGlitchTestNetwork;
